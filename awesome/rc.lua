...
globalkeys = mytable.join(
	...
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn("gscreenshot -s -c -n")
	end, { description = "take a screenshot", group = "hotkeys" }),

	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn("discord")
	end, { description = "open discord", group = "hotkeys" }),
  ...
  awful.key({ modkey }, "l", function ()
	...
	awful.key(
		...
		function()
			os.execute("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+")
      volume_widget:inc(5)
		end,
	...
	awful.key(
      ...
      volume_widget:toggle()
		...
		{ description = "toggle speaker", group = "hotkeys" }
	),
